...
public class T1_WebTable_Order_Verify {
    ...
    public void order_name_verify_test(){
        ...
        //verify Bob Martin's name is listed as expected
        ...
        WebElement bobOrderDate = driver.findElement(By.xpath("//table[@id='ctl00_MainContent_orderGrid']//td[.='Bob Martin']/following-sibling::td[3]"));
    ...
    //we use the utility method we created in WebTableUtils
    @Test
    public void test2(){
